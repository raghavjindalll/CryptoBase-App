      ...
      <div className='grid md:grid-cols-2 gap-8'>
        <div>
          ...
          <div className='flex justify-between py-4'>
            <div>
              <p>Market Cap</p>
              {coin.market_data?.market_cap ? (<p className='text-gray-500 text-sm'>${coin.market_data.market_cap.usd.toLocaleString()}</p>) : null}
            </div>
            <div>
